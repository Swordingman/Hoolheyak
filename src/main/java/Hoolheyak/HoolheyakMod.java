...
public class HoolheyakMod implements
    ...
    public void receivePostInitialize() {
        ...
        BaseMod.addPotion(AntiGravityGel.class, Color.SKY.cpy(), Color.LIME, null, AntiGravityGel.POTION_ID, Hoolheyak.Meta.HOOLHEYAK);
        BaseMod.addPotion(AstrolabeResidue.class, Color.GOLD, null, null, AstrolabeResidue.POTION_ID, Hoolheyak.Meta.HOOLHEYAK);
        BaseMod.addPotion(ElixirOfEpiphany.class, Color.CHARTREUSE, Color.BLUE, null, ElixirOfEpiphany.POTION_ID, Hoolheyak.Meta.HOOLHEYAK);
    ...
    public void receiveEditKeywords() {
        ...
        if (!Gdx.files.internal(path).exists()) {
            ...
            path = HoolheyakMod.localizationPath(lang, "Keywords.json");
        }
